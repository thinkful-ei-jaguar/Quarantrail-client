...
export default class Store extends Component {
    ...
    handlePlusTp = () => {
      if(this.state.toiletPaperCounter + this.context.starter.toiletpaper === 6) {
        return;
      }
    ...
    tooMuch = () => {
      return(
        <div class="middle">
            ...
            <p>You have too much and the other shoppers decided to take out of your cart so bye-bye good luck
            </p>
    ...
    render() {
        return(
        <>
        {this.state.tooMuch ? this.tooMuch() : this.original()}
        </>
    )}
}