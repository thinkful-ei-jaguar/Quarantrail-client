...
export default class FirstDay extends Component {
    ...
    originalbox=()=>{
        ...
        <div class="middle">
                ...
                <div class="slidecontainer">
                    <input onChange={this.handleChangeFood} value={this.state.food} type="range" min="0" max="6" class="slider" id="myRange"/>
                </div>
                <h2>How much ToiletPaper: {this.state.Toilet}</h2>
                <div class="slidecontainer">
                    <input onChange={this.handleChangeToilet} value={this.state.Toilet} type="range" min="0" max="6" class="slider" id="myRange"/>
                </div>
    ...
    render(){
        return(
            <>
            {this.state.tooMuch?this.originalbox():this.Toomuch()}
            </>
        )
    }
}